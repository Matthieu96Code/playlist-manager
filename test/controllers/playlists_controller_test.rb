...
class PlaylistsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create playlist" do
    assert_difference("Playlist.count") do
      post playlists_url, params: { playlist: { date: @playlist.date, name: @playlist.name, song_id: @playlist.song_id } }
    end
  ...
  test "should update playlist" do
    patch playlist_url(@playlist), params: { playlist: { date: @playlist.date, name: @playlist.name, song_id: @playlist.song_id } }
